export const l = {
    ...
    SETTINGS_EXPERIMENTAL_INLINE_FOOTNOTES: 'Inline comments',
    SETTINGS_EXPERIMENTAL_INLINE_FOOTNOTES_DESC: 'Treat inline footnote at the end of annotation as comment and display it below annotation',
